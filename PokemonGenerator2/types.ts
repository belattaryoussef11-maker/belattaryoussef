...
export interface Pokemon {
  ...
  type: string; // Added: The type of the Pokémon (e.g., Fire, Water, Grass)
  attack: number; // New: Attack stat of the Pokémon
  attackName: string; // New: Name of the attack (e.g., Tackle, Ember)
  pv: number; // New: Health Points (PV) stat of the Pokémon
